...
export const sections = [
  ...
  {name:'DEX',items:[{"name":"001 · SHIVAM","tag":"OWNER ENTRY","copy":"Shivam Mahajan is the first registered developer in SM’s Dex.","facts":["@SMRESPONSIBILITIES","DRAGON / STEEL","SOFTWARE DEVELOPER"]},{"name":"002 · RIYASAINII448","tag":"FAIRY / WATER","copy":"i code and i try to add whimsy to it, trying to turn my ideas into things that work.","facts":["@RIYASAINII448","AMAZING POKEMON","STATUS · UNCAUGHT","I Love Cheese, Chocolates And The Color Pink."]},{"name":"PUBLIC ROSTER","tag":"2 REGISTERED DEVELOPERS","copy":"Approved developer entries live here inside every Pokédex. Add Pokémon submits the next entry for review.","facts":["001 · SHIVAM MAHAJAN","002 · RIYASAINII448","GITHUB-REVIEWED SUBMISSIONS"]}]}
];
