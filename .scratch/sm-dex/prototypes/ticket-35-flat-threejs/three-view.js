...
export function createThree(host,screens,onProjection,options={}){
  ...
  function view(preset){root.rotation.set(preset==='front'?0:-.10,preset==='front'?0:preset==='hinge'?.52:-.22,0);root.scale.setScalar(buttonsOnly?1:preset==='hinge'?.90:.97);render();onProjection();}
