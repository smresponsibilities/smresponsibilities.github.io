...
for(const gen of ['red','gold','ruby','diamond','black']){
  await page.goto(`http://127.0.0.1:4173/.scratch/sm-dex/prototypes/ticket-45-all-generations/?gen=${gen}&open=1&v=56.1`);
...
await writeFile('.scratch/sm-dex/research/ticket-56-layout.json',JSON.stringify({results,errors},null,2));
